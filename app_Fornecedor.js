...
var a = `insert into TB_FORNECEDOR (id_Fornecedor, Nome, CEP, Complemento , Status_Fornecedor, Telefone_Fornecedor)  values (${id}, "${nome}", "${cep}", "${complemento}",  ${status} , "${telefone}");`;
